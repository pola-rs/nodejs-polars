...
describe("series", () => {
  ...
  it.each`
    ...
    ${"ewmMean"}         | ${pl.Series([2, 5, 3]).ewmMean()}                                                              | ${pl.Series([2.0, 4.0, 3.4285714285714284])}
    ${"ewmMean"}         | ${pl.Series([2, 5, 3]).ewmMean({ alpha: 0.5, adjust: true, ignoreNulls: true })}               | ${pl.Series([2.0, 4.0, 3.4285714285714284])}
    ${"ewmMean"}         | ${pl.Series([2, 5, 3]).ewmMean(0.5, true, 1, false)}                                           | ${pl.Series([2.0, 4.0, 3.4285714285714284])}
    ${"ewmMean"}         | ${pl
  .Series([2, 5, 3])
  .ewmMean({ alpha: 0.5, adjust: false, ignoreNulls: true })}          | ${pl.Series([2.0, 3.5, 3.25])}
    ${"ewmMean"}         | ${pl.Series([2, 5, 3]).ewmMean(0.5, false, 1, true)}                                           | ${pl.Series([2.0, 3.5, 3.25])}
    ${"ewmMean"}         | ${pl
  .Series([2, 3, 5, 7, 4])
  .ewmMean({ adjust: true, minPeriods: 2, ignoreNulls: true })}  | ${pl.Series([null, 2.6666666666666665, 4, 5.6, 4.774193548387097])}
    ${"ewmStd"}          | ${pl.Series([2, 5, 3]).ewmStd().round(5)}                                                      | ${pl.Series([0, 2.12132, 1.38873])}
    ${"ewmStd"}          | ${pl
  .Series([2, 5, 3])
  .ewmStd({ alpha: 0.5, adjust: true, ignoreNulls: true })
  .round(5)} | ${pl.Series([0, 2.12132, 1.38873])}
    ${"ewmStd"}          | ${pl.Series([2, 5, 3]).ewmStd(0.5, true, 1, false).round(5)}                                   | ${pl.Series([0, 2.12132, 1.38873])}
    ${"ewmVar"}          | ${pl.Series([2, 5, 3]).ewmVar().round(5)}                                                      | ${pl.Series([0, 4.5, 1.92857])}
    ${"ewmVar"}          | ${pl
  .Series([2, 5, 3])
  .ewmVar({ alpha: 0.5, adjust: true, ignoreNulls: true })
  .round(5)} | ${pl.Series([0, 4.5, 1.92857])}
    ${"ewmVar"}          | ${pl.Series([2, 5, 3]).ewmVar(0.5, true, 1, false).round(5)}                                   | ${pl.Series([0, 4.5, 1.92857])}
